// Command ApiErrorHandler-mcp is an MCP server exposing the ApiErrorHandler
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ApiErrorHandler_list  — list records of an entity
//	ApiErrorHandler_load  — load a single record of an entity
//
