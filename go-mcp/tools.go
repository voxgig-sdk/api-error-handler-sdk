...
type Args struct {
	Entity string         `json:"entity" jsonschema:"logo_generation"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ApiErrorHandlerSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "api-error-handler_list",
		Description: "List records from ApiErrorHandler. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "api-error-handler_load",
		Description: "Load a single record from ApiErrorHandler. " +
...
func runOp(client *sdk.ApiErrorHandlerSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ApiErrorHandlerSDK, name string) (sdk.ApiErrorHandlerEntity, error) {
	switch strings.ToLower(name) {
	case "logo_generation":
		return client.LogoGeneration(nil), nil
