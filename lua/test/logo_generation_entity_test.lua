...
describe("LogoGenerationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set APIERRORHANDLER_TEST_LOGO_GENERATION_ENTID JSON to run live")
      return
    end
...
function logo_generation_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("APIERRORHANDLER_TEST_LOGO_GENERATION_ENTID")
