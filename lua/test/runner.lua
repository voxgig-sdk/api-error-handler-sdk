...
function runner.env_override(m)
  local live = runner.getenv("APIERRORHANDLER_TEST_LIVE")
  local override = runner.getenv("APIERRORHANDLER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("APIERRORHANDLER_TEST_EXPLAIN")
