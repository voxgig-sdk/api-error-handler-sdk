...
describe("LogoGenerationDirect", function()
  it("should direct-load-logo_generation", function()
    local setup = logo_generation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-logo_generation", setup.live and "live" or "unit")
...
function logo_generation_direct_setup(mockres)
  ...
  local live = env["API_ERROR_HANDLER_TEST_LIVE"] == "TRUE"
