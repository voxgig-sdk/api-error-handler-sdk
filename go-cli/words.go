...
func registerSDKWords(r *eng.Registry, client *sdk.ApiErrorHandlerSDK) {
...
func runOp(client *sdk.ApiErrorHandlerSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
