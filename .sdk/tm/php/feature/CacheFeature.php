...
// ApiErrorHandler SDK cache feature
...
class ApiErrorHandlerCacheFeature extends ApiErrorHandlerBaseFeature
{
    ...
    private function _through(ApiErrorHandlerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
