...
// ApiErrorHandler SDK audit feature
...
class ApiErrorHandlerAuditFeature extends ApiErrorHandlerBaseFeature
{
    ...
    private function _emit(ApiErrorHandlerContext $ctx, string $outcome): void
    {
