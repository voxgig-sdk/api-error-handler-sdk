...
// ApiErrorHandler SDK telemetry feature
...
class ApiErrorHandlerTelemetryFeature extends ApiErrorHandlerBaseFeature
{
    ...
    private function _close(ApiErrorHandlerContext $ctx, bool $ok): void
    {
