...
// ApiErrorHandler SDK idempotency feature
...
class ApiErrorHandlerIdempotencyFeature extends ApiErrorHandlerBaseFeature
{
    ...
    private function _mutating(ApiErrorHandlerContext $ctx): bool
    {
