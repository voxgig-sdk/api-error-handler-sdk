...
// ApiErrorHandler SDK netsim feature
...
class ApiErrorHandlerNetsimFeature extends ApiErrorHandlerBaseFeature
{
    ...
    private function _simulate(ApiErrorHandlerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ApiErrorHandlerContext $ctx, array $applied): void
    {
        $client = $this->client;
