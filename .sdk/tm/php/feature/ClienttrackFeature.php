...
// ApiErrorHandler SDK clienttrack feature
...
class ApiErrorHandlerClienttrackFeature extends ApiErrorHandlerBaseFeature
{
    ...
    public function PostConstruct(ApiErrorHandlerContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ApiErrorHandler-SDK';
