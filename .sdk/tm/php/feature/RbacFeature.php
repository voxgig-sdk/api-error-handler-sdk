...
// ApiErrorHandler SDK rbac feature
...
class ApiErrorHandlerRbacFeature extends ApiErrorHandlerBaseFeature
{
    ...
    private function _required(ApiErrorHandlerContext $ctx): ?string
    {
    ...
    private function _reject(ApiErrorHandlerContext $ctx, string $required): void
    {
    ...
    private function _track(ApiErrorHandlerContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
