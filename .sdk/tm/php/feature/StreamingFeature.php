...
// ApiErrorHandler SDK streaming feature
...
class ApiErrorHandlerStreamingFeature extends ApiErrorHandlerBaseFeature
{
    ...
    private function _iterate(ApiErrorHandlerResult $result): \Generator
    {
    ...
    private function _streamable(ApiErrorHandlerContext $ctx): bool
    {
