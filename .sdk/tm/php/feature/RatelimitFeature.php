...
// ApiErrorHandler SDK ratelimit feature
...
class ApiErrorHandlerRatelimitFeature extends ApiErrorHandlerBaseFeature
{
    ...
    private function _acquire(ApiErrorHandlerContext $ctx): void
    {
    ...
    private function _track(ApiErrorHandlerContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
