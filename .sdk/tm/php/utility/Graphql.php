...
// ApiErrorHandler SDK utility: graphql
//
...
class ApiErrorHandlerGraphql
{
    ...
    // equivalent.
    public static function body(ApiErrorHandlerContext $ctx): mixed
    {
    ...
    public static function errors(ApiErrorHandlerContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
