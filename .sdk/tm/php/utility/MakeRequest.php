...
// ApiErrorHandler SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ApiErrorHandlerMakeRequest
{
    public static function call(ApiErrorHandlerContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ApiErrorHandlerResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ApiErrorHandlerResponse($fetched);
        } else {
