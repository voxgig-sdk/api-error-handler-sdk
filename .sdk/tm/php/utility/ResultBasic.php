...
// ApiErrorHandler SDK utility: result_basic

class ApiErrorHandlerResultBasic
{
    public static function call(ApiErrorHandlerContext $ctx): ?ApiErrorHandlerResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof ApiErrorHandlerError) ? $result->err->msg : (string)$result->err;
