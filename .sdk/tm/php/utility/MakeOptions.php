...
// ApiErrorHandler SDK utility: make_options

class ApiErrorHandlerMakeOptions
{
    ...
    public static function call(ApiErrorHandlerContext $ctx): array
    {
        ...
        //
        // `ApiErrorHandlerSchema::optspec()` is built from the model:
        ...
        $optspec = ApiErrorHandlerSchema::optspec();
