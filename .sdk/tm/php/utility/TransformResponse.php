...
// ApiErrorHandler SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ApiErrorHandlerTransformResponse
{
    public static function call(ApiErrorHandlerContext $ctx): mixed
    {
        ...
        $transform = ApiErrorHandlerHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
