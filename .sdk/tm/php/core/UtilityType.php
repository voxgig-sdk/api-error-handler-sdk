...
// ApiErrorHandler SDK utility type

class ApiErrorHandlerUtility
{
    ...
    public static function copy(ApiErrorHandlerUtility $src): ApiErrorHandlerUtility
    {
        $u = new ApiErrorHandlerUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
