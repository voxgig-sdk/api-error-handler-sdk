...
from projectname_sdk.core.control import ApiErrorHandlerControl
...
class ApiErrorHandlerContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ApiErrorHandlerControl()
        ...
        if isinstance(sp, ApiErrorHandlerSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ApiErrorHandlerResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ApiErrorHandlerResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ApiErrorHandlerOperation({})
    ...
    def make_error(self, code, msg):
        return ApiErrorHandlerError(code, msg, self)
