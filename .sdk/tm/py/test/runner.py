...
class ApiErrorHandlerTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ApiErrorHandlerTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ApiErrorHandlerTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ApiErrorHandlerTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
