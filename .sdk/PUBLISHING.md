...
|---|---|---|
| `ts/` | @voxgig-sdk/api-error-handler-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/api-error-handler-sdk \
      --repository voxgig-sdk/api-error-handler-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/api-error-handler-sdk` shows it, and
`npm trust revoke @voxgig-sdk/api-error-handler-sdk --id=<id>` removes it.
