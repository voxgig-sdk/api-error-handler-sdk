...
#      offline in seeded test mode (ApiErrorHandlerSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ApiErrorHandler_sdk.rb")
  SDK_CLASS = "ApiErrorHandlerSDK"
