...
Results: Successful response with generated logo.
...
| --- | --- | --- | --- |
| LogoGeneration | `load` | `GET /api/logo/glitch` | See reference |
...
- `api-error-handler_list`: List records for an entity. No active entity supports this operation.
- `api-error-handler_load`: Load one record for an entity. Supported entities: `logo_generation`.
