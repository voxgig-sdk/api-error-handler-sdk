# ApiErrorHandler SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ApiErrorHandlerSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ApiErrorHandlerSDK(...) and ApiErrorHandlerSDK.test(...) become
#      ApiErrorHandlerSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "apierrorhandler_sdk"
_SDK_CLASS = "ApiErrorHandlerSDK"
...
_ENTITIES = {
    "LogoGeneration": "logo_generation",
}
