...
from apierrorhandler_sdk.utility import register

# Load features
from apierrorhandler_sdk.feature.base_feature import ApiErrorHandlerBaseFeature
from apierrorhandler_sdk.features import _has_feature, _make_feature
...
class ApiErrorHandlerSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ApiErrorHandlerUtility()
        self._utility = utility

        from apierrorhandler_sdk.config import shared_config
    ...
    def get_utility(self):
        return ApiErrorHandlerUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ApiErrorHandlerSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def LogoGeneration(self, data=None) -> "LogoGenerationEntity":
        ...
        from apierrorhandler_sdk.entity.logo_generation_entity import LogoGenerationEntity
        return LogoGenerationEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ApiErrorHandlerSDK":
        if sdkopts is None:
            sdkopts = {}
