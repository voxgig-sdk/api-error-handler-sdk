...
(0, node_test_1.describe)('LogoGenerationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ApiErrorHandlerSDK({
    ...
    (0, node_test_1.test)('direct-load-logo_generation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-logo_generation', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.API_ERROR_HANDLER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ApiErrorHandlerSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['API_ERROR_HANDLER_TEST_LOGO_GENERATION_ENTID'];
    ...
    const client = new __1.ApiErrorHandlerSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=LogoGenerationDirect.test.js.map