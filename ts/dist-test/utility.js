...
function envOverride(m) {
    if ('TRUE' === process.env.API_ERROR_HANDLER_TEST_LIVE ||
        'TRUE' === process.env.API_ERROR_HANDLER_TEST_OVERRIDE) {
    ...
    m.API_ERROR_HANDLER_TEST_EXPLAIN = process.env.API_ERROR_HANDLER_TEST_EXPLAIN || m.API_ERROR_HANDLER_TEST_EXPLAIN;
    return m;
}
