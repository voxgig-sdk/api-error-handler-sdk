...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.APIERRORHANDLER_TEST_LIVE ||
    'TRUE' === process.env.APIERRORHANDLER_TEST_OVERRIDE
  ) {
  ...
  m.APIERRORHANDLER_TEST_EXPLAIN = process.env.APIERRORHANDLER_TEST_EXPLAIN || m.APIERRORHANDLER_TEST_EXPLAIN
