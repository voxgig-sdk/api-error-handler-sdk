...
exports.ApiErrorHandlerEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends ApiErrorHandlerEntityBase<Advice>`.
class ApiErrorHandlerEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.ApiErrorHandlerEntityBase = ApiErrorHandlerEntityBase;
//# sourceMappingURL=ApiErrorHandlerEntityBase.js.map