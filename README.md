...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/api-error-handler` | `npm install @voxgig-sdk/api-error-handler` |
| Python | `voxgig-sdk-api-error-handler` | `pip install voxgig-sdk-api-error-handler` |
| PHP | `voxgig-sdk/api-error-handler` | `composer require voxgig-sdk/api-error-handler` |
| Golang | `github.com/voxgig-sdk/api-error-handler-sdk/go` | `go get github.com/voxgig-sdk/api-error-handler-sdk/go` |
| Ruby | `voxgig-sdk-api-error-handler` | `gem install voxgig-sdk-api-error-handler` |
| Lua | `voxgig-sdk-api-error-handler` | `luarocks install voxgig-sdk-api-error-handler` |
