...
import (
	...
	"github.com/voxgig-sdk/api-error-handler-sdk/go/entity"
	"github.com/voxgig-sdk/api-error-handler-sdk/go/feature"
	_ "github.com/voxgig-sdk/api-error-handler-sdk/go/utility"
)
...
// instead of `sdk.NewApiErrorHandlerSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *ApiErrorHandlerSDK  { return NewApiErrorHandlerSDK(nil) }
func Test() *ApiErrorHandlerSDK { return TestSDK(nil, nil) }
