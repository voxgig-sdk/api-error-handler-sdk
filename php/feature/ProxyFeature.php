...
// ApiErrorHandler SDK proxy feature
...
class ApiErrorHandlerProxyFeature extends ApiErrorHandlerBaseFeature
{
    ...
    public function init(ApiErrorHandlerContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ApiErrorHandlerContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
