...
// ApiErrorHandler SDK metrics feature
...
class ApiErrorHandlerMetricsFeature extends ApiErrorHandlerBaseFeature
{
    ...
    private function _record(ApiErrorHandlerContext $ctx, bool $ok): void
    {
