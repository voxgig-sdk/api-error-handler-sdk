...
// ApiErrorHandler SDK timeout feature
...
class ApiErrorHandlerTimeoutFeature extends ApiErrorHandlerBaseFeature
{
    ...
    private function _with_timeout(ApiErrorHandlerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ApiErrorHandlerContext $_ctx, float $ms): void
    {
        $client = $this->client;
