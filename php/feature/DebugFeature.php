...
// ApiErrorHandler SDK debug feature
...
class ApiErrorHandlerDebugFeature extends ApiErrorHandlerBaseFeature
{
    ...
    private function _finish(ApiErrorHandlerContext $ctx, bool $ok): void
    {
