...
class ApiErrorHandlerSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = ApiErrorHandlerHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = ApiErrorHandlerHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!ApiErrorHandlerFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, ApiErrorHandlerFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return ApiErrorHandlerUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = ApiErrorHandlerHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = ApiErrorHandlerHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = ApiErrorHandlerHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new ApiErrorHandlerError($op . "_allow",
                "ApiErrorHandlerSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = ApiErrorHandlerHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new ApiErrorHandlerError("graphql_error",
                "ApiErrorHandlerSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function LogoGeneration($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_logo_generation === null) {
                $this->_logo_generation = new LogoGenerationEntity($this, null);
            }
            return $this->_logo_generation;
        }
        return new LogoGenerationEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new ApiErrorHandlerSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
