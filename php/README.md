# ApiErrorHandler PHP SDK



The PHP SDK for the ApiErrorHandler API — an entity-oriented client using PHP conventions.
...
try {
    ...
    print_r($logogeneration->data_get());
} catch (\Throwable $err) {
...
```php
require_once 'apierrorhandler_sdk.php';
$client = new ApiErrorHandlerSDK($options);
```
...
```
php/
├── apierrorhandler_sdk.php          -- Main SDK class
...
The main class (`apierrorhandler_sdk.php`) exports the SDK class
