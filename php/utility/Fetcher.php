...
// ApiErrorHandler SDK utility: fetcher

class ApiErrorHandlerFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ApiErrorHandlerSDK/1.0)';
    ...
    public static function call(ApiErrorHandlerContext $ctx, string $fullurl, array $fetchdef): array
    {
