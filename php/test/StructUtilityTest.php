...
// ApiErrorHandler SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ApiErrorHandlerOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ApiErrorHandlerOmni::structfix($now, Struct::undef()))
                        !== json_encode(ApiErrorHandlerOmni::structfix($val, Struct::undef()))) {
