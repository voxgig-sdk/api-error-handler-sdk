...
// ApiErrorHandler SDK pipeline test
//
...
{
    private static function utility(): ApiErrorHandlerUtility
    {
        return new ApiErrorHandlerUtility();
    }
    ...
    private static function ctx(array $over = []): ApiErrorHandlerContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ApiErrorHandlerContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ApiErrorHandlerOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ApiErrorHandlerError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ApiErrorHandlerOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ApiErrorHandlerMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ApiErrorHandlerOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ApiErrorHandlerMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ApiErrorHandlerOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ApiErrorHandlerMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ApiErrorHandlerSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ApiErrorHandlerMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ApiErrorHandlerResponse([]),
            'result' => new ApiErrorHandlerResult([]),
        ]);
        [, $err] = ApiErrorHandlerMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ApiErrorHandlerSpec([]),
            'response' => null,
            'result' => new ApiErrorHandlerResult([]),
        ]);
        [, $err] = ApiErrorHandlerMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ApiErrorHandlerSpec(['step' => 's']),
            'response' => new ApiErrorHandlerResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ApiErrorHandlerResult([]),
        ]);
        [, $err] = ApiErrorHandlerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ApiErrorHandlerSpec(['step' => 's']),
            'response' => new ApiErrorHandlerResponse(self::resp(200, ['v' => 1])),
            'result' => new ApiErrorHandlerResult([]),
        ]);
        [, $err] = ApiErrorHandlerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ApiErrorHandlerSpec(['step' => 's']),
            'response' => new ApiErrorHandlerResponse(self::resp(200, ['v' => 2])),
            'result' => new ApiErrorHandlerResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ApiErrorHandlerMakeResponse::call($ctx);
    ...
    {
        $preset = new ApiErrorHandlerResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ApiErrorHandlerSpec([]),
            'response' => new ApiErrorHandlerResponse([]),
            'result' => new ApiErrorHandlerResult([]),
        ...
        [$got, $err] = ApiErrorHandlerMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ApiErrorHandlerResult([])]);
        [, $err] = ApiErrorHandlerMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ApiErrorHandlerSpec([]), 'result' => null]);
        [, $err] = ApiErrorHandlerMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ApiErrorHandlerSpec(['step' => 's']),
            'result' => new ApiErrorHandlerResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ApiErrorHandlerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ApiErrorHandlerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ApiErrorHandlerSpec(['step' => 's']),
            'result' => new ApiErrorHandlerResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ApiErrorHandlerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ApiErrorHandlerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ApiErrorHandlerResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ApiErrorHandlerSpec([]),
            'result' => new ApiErrorHandlerResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ApiErrorHandlerMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ApiErrorHandlerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ApiErrorHandlerError('boom', 'boom');
        $utility->fetcher = function (ApiErrorHandlerContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ApiErrorHandlerSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ApiErrorHandlerMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ApiErrorHandlerContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ApiErrorHandlerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ApiErrorHandlerResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ApiErrorHandlerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ApiErrorHandlerContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ApiErrorHandlerSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ApiErrorHandlerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ApiErrorHandlerResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ApiErrorHandlerSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ApiErrorHandlerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ApiErrorHandlerMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ApiErrorHandlerMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ApiErrorHandlerResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ApiErrorHandlerDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ApiErrorHandlerResult(['ok' => false])]);
        $this->expectException(ApiErrorHandlerError::class);
        ApiErrorHandlerDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ApiErrorHandlerResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ApiErrorHandlerMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ApiErrorHandlerMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ApiErrorHandlerBaseFeature();
        $b = new ApiErrorHandlerBaseFeature();
        ApiErrorHandlerFeatureAdd::call($ctx, $a);
        ApiErrorHandlerFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ApiErrorHandlerBaseFeature
    {
        $f = new ApiErrorHandlerBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ApiErrorHandlerFeatureAdd::call($ctx, self::named_feature('a'));
        ApiErrorHandlerFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        ApiErrorHandlerFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        ApiErrorHandlerFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        ApiErrorHandlerFeatureAdd::call($ctx, $replace);
        ...
        ApiErrorHandlerFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ApiErrorHandlerContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ApiErrorHandlerSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ApiErrorHandlerPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ApiErrorHandlerPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ApiErrorHandlerResponse(['headers' => null]),
            'result' => new ApiErrorHandlerResult([]),
        ]);
        ApiErrorHandlerResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ApiErrorHandlerResultBody::call($ctx);
