...
// ApiErrorHandler SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ApiErrorHandlerSDK::test)
...
{
    private const SDK_CLASS = 'ApiErrorHandlerSDK';
    ...
    private const SDK_BASE = 'apierrorhandler_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../apierrorhandler_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
